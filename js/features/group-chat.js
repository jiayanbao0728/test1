window.switchStatsTab = function(tab) {
    ...
    if (modal) {
        modal.classList.remove('stats-view-stats', 'stats-view-search', 'stats-view-favorites', 'stats-view-wordcloud');
        modal.classList.add('stats-view-' + tab);
    }
    ...
    if (tab === 'stats') {
        ...
        requestAnimationFrame(function() {
            ...
            if (container) {
                container.innerHTML = '';
                container._currentView = container._currentView || 'all';
                container.scrollTop = 0;
            }
            if (wordcloudPanel) wordcloudPanel.scrollTop = 0;
            setTimeout(function() {
