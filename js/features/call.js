  ...
  <button class="call-mini-hangup" id="call-mini-hangup">${SVG_HU}</button>
    ...
    function initDrag() {
        ...
        hdr.addEventListener('pointerdown', e => {
            if (e.target.closest('button, input, select, textarea, .call-top-btn')) return;
    ...
    function bindEvents() {
        ...
        document.getElementById('call-window')?.addEventListener('pointerdown', e => {
            if (e.target.closest('button, input, select, textarea')) e.stopPropagation();
        }, true);

        document.getElementById('call-hangup-btn')?.addEventListener('click', e => { e.stopPropagation(); endCall(); });
        document.getElementById('call-mini-hangup')?.addEventListener('click', e => { e.stopPropagation(); endCall(); });
        document.getElementById('call-minimize-btn')?.addEventListener('click', e => { e.stopPropagation(); minimizeWindow(); });
        ...
        document.getElementById('call-bg-btn')?.addEventListener('click', e => {
            e.stopPropagation();
