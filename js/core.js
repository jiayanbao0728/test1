...
autoSendInterval: 5,
        ...
        inviteStudySoundPreset: 'default',
        inviteStudyCustomSoundUrl: '',
        inviteWorkSoundPreset: 'default',
        inviteWorkCustomSoundUrl: '',
        inviteExerciseSoundPreset: 'default',
        inviteExerciseCustomSoundUrl: '',
        inviteSleepSoundPreset: 'default',
        inviteSleepCustomSoundUrl: '',
        inviteVideocallSoundPreset: 'default',
        inviteVideocallCustomSoundUrl: '',
        soundVolume: 0.15,
    ...
    if (message.sender === 'user' && message.type === 'normal' && typeof window._onUserMessage === 'function') {
        ...
        function sendMessage(textOverride = null, type = 'normal') {
            ...
            const createMessage = (imgSrc = null) => {
                ...
                if (!isBatchMode && type === 'normal' && typeof window._triggerDelayedReply === 'function') {
